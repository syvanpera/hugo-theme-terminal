...
This theme is based on (and forked off of) [Terminal](https://github.com/panr/hugo-theme-terminal) and is inspired by [Base16](https://github.com/htdvisser/hugo-base16-theme) and the colorscheme is [Gruvbox](https://github.com/morhetz/gruvbox).
